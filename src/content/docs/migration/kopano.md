---
title: "Kopano"
description: "Migrating Kopano is a multi-step process which also depends on the configuration of the backend used by Kopano."
sidebar:
  order: 40
---
...
On the grommunio system, Kopano databases can be imported on the command-line with [gromox-kdb2mt](/man/gromox-kdb2mt-8/) and [gromox-mt2exm](/man/gromox-mt2exm-8/). These are two commands meant to be chained together by way of a pipe; tend to the linked manual pages to read about the invocation syntax.
