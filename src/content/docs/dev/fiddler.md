---
title: "Fiddler"
description: "Fiddler installs itself as a system proxy, i.e. when Fiddler is set to capture traffic, the system proxy setting is changed to point to 127.0.0.1:8888.…"
sidebar:
  order: 30
---

Fiddler installs itself as a system proxy, i.e. when Fiddler is set to capture traffic, the system proxy setting is changed to point to 127.0.0.1:8888. Therefore, Fiddler is not entirely transparent.
