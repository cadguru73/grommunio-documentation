---
title: "EWS notes"
description: "Observations on Exchange Server's EWS"
sidebar:
  order: 70
---
...
type=1 for folders, type=9 for messages, type=15 for calendar items. CK may be just 4 bytes in case no CK exists (or so).
...
The GUIDs are of type RFC 4122 §4.1.3, hence guid byte \#7's high nibble is always '4', guid byte \#8's has always the 0x80 bit set, and guid byte \#8 is generally between 0x80..0xbf.
