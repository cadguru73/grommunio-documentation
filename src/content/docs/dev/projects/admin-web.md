---
title: "Admin Web"
description: "This webapp uses yarn and caddy for development."
sidebar:
  order: 60
---

> Sourced from the [admin-web](https://github.com/grommunio/admin-web) README.
...
Each hostname is the key of an object, which has following keys:
  <em> `logo`: The logo in the login form</em>
  <em> `logoLight`: The logo in the expanded drawer</em>
  <em> `icon`: The icon in the collapsed drawer</em>
  <em> `background`: The background image in light mode</em>
  <em> `backgroundDark`: The background image in dark mode</em>
  <em> `favicon`: The site's favicon</em>
...
- Support is available through <strong>[grommunio GmbH](https://grommunio.com)</strong> and its partners.
- grommunio Admin web community is available here: <strong>[grommunio Community](https://community.grommunio.com)</strong>
...
Please read [our contribution guidelines](https://github.com/grommunio/admin-web/blob/master/doc/CONTRIBUTING.md), and thank you for being involved!
...
_For more information and to report security issues, please refer to our [security documentation](https://github.com/grommunio/admin-web/blob/master/doc/SECURITY.md)._
...
This project is licensed under the <strong>GNU Affero General Public License v3</strong>.

See [LICENSE](https://github.com/grommunio/admin-web/blob/master/LICENSE.txt) for more information.
