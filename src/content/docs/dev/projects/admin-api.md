---
title: "Admin API"
description: "grommunio Admin API is the central API component of grommunio managing appliance(s), domain(s), users(s) and more. grommunio API orchestrates any compon…"
sidebar:
  order: 50
---

> Sourced from the [admin-api](https://github.com/grommunio/admin-api) README.
...
- Install required packages listed in the [Pipfile](https://github.com/grommunio/admin-api/blob/master/Pipfile), either as system packages or in a virtual environment
- Deploy admin-api at a location of your choice, such as `/usr/share/grommunio-admin-api`
- Configure [database connection](https://github.com/grommunio/admin-api/blob/master/conf.d/README.md#Database)
- Customize [configuration](https://github.com/grommunio/admin-api/blob/master/conf.d/README.md) as needed
- Run the [main.py](https://github.com/grommunio/admin-api/blob/master/main.py) file with `uwsgi` ([example configuration](https://github.com/grommunio/admin-api/blob/master/data/api-config.ini), [documentation](https://uwsgi-docs.readthedocs.io/en/latest/Configuration.html))
...
- Use your API client to generate calls, based on [OpenAPI specification](https://github.com/grommunio/admin-api/blob/master/res/openapi.yaml)
...
Please read [our contribution guidelines](https://github.com/grommunio/admin-api/blob/master/doc/CONTRIBUTING.md), and thank you for being involved!
...
_For more information and to report security issues, please refer to our [security documentation](https://github.com/grommunio/admin-api/blob/master/doc/SECURITY.md)._
...
See [LICENSE](https://github.com/grommunio/admin-api/blob/master/LICENSE.txt) for more information.
